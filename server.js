...
app.post('/addContact', function(req, res) {
  ...
  addContact(db,req.body.OrganizationId, req.body.Name, req.body.Surname, req.body.Phone, req.body.Email, req.body.Address, req.body.City, req.body.Country, req.body.PostCode);
}else{
  editContact(db,req.body.id ,req.body.OrganizationId, req.body.Name, req.body.Surname, req.body.Phone, req.body.Email, req.body.Address, req.body.City, req.body.Country, req.body.PostCode);
}
res.send("<script> window.location.replace('../');</script>");
});
//Request for deleting contact
app.post('/deleteContact', function(req, res) {
  deleteContact(db,req.body.id);
  res.send("<script> window.location.replace('../');</script>");
});
//Request for getting all contact of an organization
app.post('/getContacts', function(req, res) {
  let promise = returnContactsOfOrganization(db,req.body.OrganizationName);
...
app.post('/getContactDetails', function(req, res) {
  ...
  let promise = returnContactDetails(db,req.body.id);
  promise.then(function(value) {
    res.send(value);
  }, function(error) {
    console.error('uh oh: ', error); // 'uh oh: something bad happened’
...
app.post('/addOrganization', function(req, res) {
  addOrganization(db,req.body.OrganizationName, req.body.Phone, req.body.Email, req.body.Address, req.body.City, req.body.Country, req.body.PostCode);
  res.send("<script> window.location.replace('../');</script>");
});
//Request for deleting organization
app.post('/deleteOrganization', function(req, res) {
  deleteOrganization(db,req.body.OrganizationName);
  res.send("<script> window.location.replace('../');</script>");
});
//Request for addinggetting the details of an organization
app.post('/detailsOfOrganization', function(req, res) {
  let promise = detailsOfOrganization(db,req.body.OrganizationName);
  promise.then(function(value) {
    res.send(value);
  }, function(error) {
    console.error('uh oh: ', error); // 'uh oh: something bad happened’
...
app.post('/getIdOfOrganization', function(req, res) {
  let promise = returnIdOfOrganization(db,req.body.OrganizationName);
  promise.then(function(value) {
    let obj = {};
    obj.id = value;
    res.send(obj);
...
app.post('/getAllOrganizations', function(req, res) {
  let promise = returnAllOrganizations(db);
  promise.then(function(value) {
    res.send(value);
  }, function(error) {
    console.error('uh oh: ', error); // 'uh oh: something bad happened’
